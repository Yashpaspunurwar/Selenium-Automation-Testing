...
driver = webdriver.Chrome("C:\\Users\\ASUS\\Downloads\\chromedriver_win32 (1)\\chromedriver.exe")
...
try:
    ...
    driver.find_element_by_name('Name').send_keys('Yash Paspunurwar')
    time.sleep(3)
    print("Typing your Email address...")
    driver.find_element_by_name('Email').send_keys('yashpaspunurwar2000@gmail.com')
    time.sleep(3)
